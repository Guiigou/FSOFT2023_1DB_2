...
int main() {
    ...
    Teclado teclado("Teclado Gamer", 1, 5, 59.99, 25.0, "Mecanico");
    Monitor monitor("Monitor LED", 2, 5, 199.99, 150.50, 24, 165);
    Rato rato("Rato Sem Fio", 3, 5, 29.99, 12.0, 20000, true);
    PlacaMae placaMae("ASUS", 4, 5, 199.99, 150.0, "DDR4");
    PlacaGrafica placaGrafica("RTX 3060", 5, 5, 399.99, 300.0, "GDDR6");
